...
_PROTOREQUEST_REQTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BACKGROUND_CALIBRATE', index=2, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_PROTOIMAGESET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='BG', full_name='navirice.ProtoImageSet.BG', index=4,
...
_PROTOCAPTURESETTING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='BG', full_name='navirice.ProtoCaptureSetting.BG', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='count', full_name='navirice.ProtoCaptureSetting.count', index=4,
...
_PROTOIMAGESET.fields_by_name['BG'].message_type = _PROTOIMAGE
